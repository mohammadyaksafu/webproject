  ...
  return (
    <div className="min-h-screen bg-black py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        {/* Welcome Section */}
        <div className="bg-gradient-to-r from-gray-900 to-black rounded-xl shadow-lg p-6 mb-8 border border-gray-800">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold text-[#00df9a] mb-2">
                Welcome back, {user?.name || "Student"}!
              </h1>
              <p className="text-gray-400 text-lg">
                Here's your complaint summary and quick actions
              </p>
            </div>
